                ...
                <div className="card-body p-0 w-4/5 flex flex-col">
                        ...
                        <div className="flex gap-1 flex-wrap items-center">
                            {movie?.genres?.sort((a, b) => b.length - a.length).map((genre, i) => (
                                i < 5 && <>
                                    ...
                                    {(i != (movie?.genres?.length > 5 ? 5 : (movie?.genres?.length - 1))) &&
                                        <span>·</span>}
                                </>
                            ))}
                        </div>
                    ...
                    <div className="flex">
                        <button className="btn btn-sm btn-primary btn-outline">
                            <StarIcon width="1.2em" height="1.2em"/>
                            <span className="font-bold text-lg">{movie.rating}
    ...
    return (
        <div className="carousel-item" key={movie.id}>
            <div className="w-[250px]">
                    ...
                    <div className="absolute bottom-2 left-2 flex gap-2">
                        <button className="btn btn-sm btn-primary">
                            ...
                            <span className="text-lg font-bold">{movie.rating} <span
                                className="text-sm font-medium">/ 10</span></span>
                        </button>
                        <button className="btn btn-sm btn-ghost bg-gray-300 text-black">
                            <span className="">{movie.language}</span>
                        </button>
                ...
                <div className="p-2">
                    <h3 className="card-title text-lg">{movie.title_english}</h3>
                    ...
                    <div className="card-actions flex gap-1 flex-wrap items-center text-gray-400 mt-2">
